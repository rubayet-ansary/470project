...
import bracu.shout.out.v1.pkg1.DBConnect;
...
public class login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        version.setForeground(new java.awt.Color(255, 148, 120));
        ...
        jLowerPanelLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jLowerPanelLayout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void loginButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginButtonActionPerformed
        ...
        while(true)
        {
            try 
            {
                ...
                {
                    boolean check=log.stdORfac(userField.getText());
                    if(check)
                    {
